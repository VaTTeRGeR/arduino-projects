...
void vset(Vector3& v0, float x, float y, float z) {
  v0.x = x;
  v0.y = y;
  v0.z = z;
}

void vset(Vector3& v0, Vector3& v1) {
  v0.x = v1.x;
  v0.y = v1.y;
  v0.z = v1.z;
}

float vscl(Vector3& v0, float scl) {
  v0.x *= scl;
  v0.y *= scl;
  v0.z *= scl;
}

float vlen(Vector3& v0) {
  return sqrt(v0.x*v0.x + v0.y*v0.y + v0.z*v0.z);
}

float vlen2(Vector3& v0) {
...
void vlerp(Vector3& v0, Vector3& v1, float alpha) {
  v0.x += alpha * (v1.x - v0.x);
  v0.y += alpha * (v1.y - v0.y);
  v0.z += alpha * (v1.z - v0.z);
}

void vslerp(Vector3& v0, Vector3& v1, float alpha) {
